...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="mb-4">
        ...
        <input
            ...
            id="name" name="name" type="text" value="{{ old('name', $promo->name ?? '') }}" required>
        @error('name')
...
<div class="mb-4">
    ...
    @if (isset($promo) && $promo->banner_image)
        <div class="mb-2">
            <img src="{{ asset('storage/' . $promo->banner_image) }}" alt="Banner actual"
